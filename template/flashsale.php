...
<section class="container main-content landing-content" id="landing-page">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
              ...
              <h1 class="blue">Flash Sale Alert -Top Rated {{name}} for  <strong>ONLY {{market_place }} {{sale_price}}, Free Shipping!* {{ parseInt((1-sale_price/normal_price)*100)}}% Off Today Only, Free Shipping!</strong></h1>
                ...
                <div class="flex-viewport" style="overflow: hidden; position: relative;">
                    ...
                    <ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(-714px, 0px, 0px);"><li :data-thumb="'../upload/'+cur_images[0].picture" class="clone" aria-hidden="true" style="width: 357px; margin-right: 0px; float: left; display: block;">
                            ...
                            <div class="col-md-6 right">
                                   <h3>Top rated {{name}}  for only {{market_place }} {{sale_price}}, Free Shipping! by {{brand}}.{{benefit1}}, {{benefit2}}  </h3>
                    <p>Our featured deal of the day! Save {{ parseInt((1-sale_price/normal_price)*100)}}% off ! Normally {{market_place }} {{normal_price}}. Your price: only {{market_place }} {{sale_price}}- Only {{numbers_coupons_avi}}  Available. This Offer Expires {{end_date}}   (Pacific).&nbsp;</p>
                    <p>Guaranteed safe and secure checkout via Amazon.com. Click “Grab This Deal” below to get yours now!</p>
                    ...
                    <div class="col-md-12 price-holder">
                        ...
                        <div class="price-amount"> {{ parseInt((1-sale_price/normal_price)*100)}}%   <br><br></div>
                    </div>
...
<script type="text/javascript">
 ...
 var app = new Vue({
  ...
  methods:{
    ...
    goAmazon: function(){
        ...
        if(this.canonical_url ==""){
            if(this.is_super_nova_url){
                  var url = "https://www.amazon.com/s/refnb_sb_noss?url=="+this.seller_id+"&field-keywords="+noval_keyword.replace(/ /g,"+")
                  location.href =url
            }else{
    ...
    grabCoupon: function(){
        location.href = "./flashsale_buy_now.php?cid="+getUrlParameter('cid')+"&offer_id="+getUrlParameter('offer_id');
