...
<div class="container main thanks">
    ...
    <div class="row intro"> <!-- intro, code and timer -->
        ...
        <section class="content">
            ...
            <div class="col-md-6">
                ...
                <p>Yes, you read correctly! Because you saw this page, you will get this top-rated {{name}} for <strong>{{ parseInt((1-sale_price/normal_price)*100)}}% off ({{market_place }}{{normal_price}} value) with Free Amazon PRIME shipping, when you purchase the {{name}} for only {{market_place }}{{sale_price}}, Free Shipping! for only {{market_place }}{{sale_price}}.</strong></p>
                <p>You'll order through Amazon so your purchase is 100% safe and secure. Plus, if you're a prime member you'll even get free shipping! You're going to go through the clickable link we'll give you below that takes you directly to the amazon page to checkout. Then use the special coupon code we've provided to you on this page to get the {{name}} for {{ parseInt((1-sale_price/normal_price)*100)}}% off.</p>
            </div>
    ...
    <div class="row"> <!-- sub-title -->
        ...
        <section class="content redeem-steps">
            ...
            <div class="col-md-12">
                <h2 class="red">To Redeem Your Coupon for the {{ parseInt((1-sale_price/normal_price)*100)}}% Off Product,<br>
    ...
    <div class="row"> <!-- sub-title -->
        ...
        <section class="content redeem-steps">
            ...
            <div class="row step-box">
                <div class="col-md-6">
                    <img class="center" src="./buy_together_discount/no1.png">
                    <p>Click on this link <a class="noref" href="javascript:void 0" v-on:click="goAmazon" >right here to add both items</a> to your cart - the {{name}} for only {{market_place }}{{sale_price}}, Free Shipping! &amp; {{name}}. This way you are sure to add the right items to your cart, so you can claim the {{ parseInt((1-sale_price/normal_price)*100)}}% off deal.</p>
                    <a href="javascript:void 0" v-on:click="goAmazon" class="noref" >
            ...
            <div class="row step-box">
                <div class="col-md-6">
                    <img class="center" src="./buy_together_discount/no2.png">
                    <p>Then click the <strong>"Continue"</strong> button.<br>
            ...
            <div class="row step-box">
                <div class="col-md-6">
                    <img class="center" src="./buy_together_discount/no3.png">
                ...
                <div class="col-md-6">
                    <img src="./buy_together_discount/imac-screen3.jpg">
                </div>
            </div>
    ...
    <div class="row"> <!-- coupons -->
        ...
        <section class="content">
            ...
            <div class="col-md-10 cta use">
                ...
                <a class="noref" href="javascript:void 0" v-on:click="goAmazon" >
    ...
    <div class="row"> <!-- FAQ -->
        <section class="content faq">
            ...
            <div class="col-md-12 check-out">
                ...
                <a class="noref" href="javascript:void 0" v-on:click="goAmazon" >Buy This On Amazon Now</a>
