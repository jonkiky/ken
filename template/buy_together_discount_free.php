...
<div class="container main">
    ...
    <div class="row">
        ...
        <section class="col-md-12">
            <div class="headline">
                <h1><span>FREE</span> BOGO DEAL</h1>
            </div>
        </section>
    ...
    <div class="row"> <!-- featured section -->
        ...
        <section class="col-md-12 content">
            ...
            <h2><span class="emphasis">Buy This</span> Popular Best Selling {{name}} for only {{market_place }}{{sale_price}}, Free Shipping! On Amazon, and <span class="emphasis">Get THIS Amazing Product 100% FREE!</span></h2>
    ...
    <div class="row"> <!-- amazon deal text -->
        ...
        <section class="content">
            ...
            <div class="col-md-8 main-info">
                ...
                <p><span class="emphasis-two">What if I told you that you could get an AMAZING Free1, 100% for FREE?</span> Well, we've made special arrangements to make that happen for you!</p>

                <h3 class="center red">Here's how it works:</h3>

                <p>This is a special <span class="emphasis-two">Amazon coupon deal.</span> Grab this top-rated Free1 for <span class="emphasis-two">FREE ($Free2 value)</span> with Free Amazon PRIME shipping, when you purchase the {{name}} for only {{ parseInt((1-sale_price/normal_price)*100)}}%, Free Shipping! for only {{ parseInt((1-sale_price/normal_price)*100)}}%. </p>
        ...
        <section class="content">
            ...
            <div class="col-md-10 cta">
                ...
                <p class="center">• Then, follow the instructions on how to get your
                    FREE product on the next page.</p>

                                    <a class="btn-warning" href="javascript:void 0" v-on:click="grabCoupon"><i class="fa fa-arrow-right" aria-hidden="true"></i> Grab My Coupon Deal</a>
                            </div>
            <div class="col-md-1"></div>
        </section>
    ...
    <div class="row">
        ...
        <section class="content limited-section">
            ...
            <div class="col-md-8">
                ...
                <p>Grab this top-rated Free1 for <span class="emphasis-two">FREE ($Free2 value)</span> with Free Amazon PRIME shipping, when you purchase the {{name}}for only  {{market_place }}{{sale_price}}, Free Shipping! for only  {{market_place }}{{sale_price}}.</p>
            ...
            <div class="col-md-4">
                <img class="center" src="./buy_together_discount_free/photo.png" alt="">
            </div>
        ...
        <section class="content">
            ...
            <div class="col-md-10 steps">
                ...
                <div class="row flexin">
                    <div class="col-md-1"><img class="max" src="./buy_together_discount_free/1.png"></div>
                    <div class="col-md-9"><p>• Get your <strong>Amazon Coupon Code</strong> for this deal</p></div>
                    <div class="col-md-2 switch"><img class="switch" src="./buy_together_discount_free/amazon_coupon.png"></div>
                </div>
                <div class="row grey flexin">
                    <div class="col-md-1"><img class="max" src="./buy_together_discount_free/2.png"></div>
                    <div class="col-md-9"><p>• Then <strong>add both items</strong> (exact instructions provided on the next page!)</p></div>
                    <div class="col-md-2 switch"><img class="switch" src="./buy_together_discount_free/Cart-128.png"></div>
                </div>
                <div class="row flexin">
                    <div class="col-md-1"><img class="max" src="./buy_together_discount_free/3.png"></div>
                    <div class="col-md-9"><p>• Use Your Coupon Code at the <strong>checkout on Amazon</strong> and get this great product for free!</p></div>
                    <div class="col-md-2 switch"><img class="switch" src="./buy_together_discount_free/amazon_checkout.png"></div>
                </div>
...
<script type="text/javascript">
 ...
 var app = new Vue({
  ...
  methods:{
    ...
    grabCoupon: function(){
        location.href = "./buy_together_discount_free_buy_now.php?cid="+getUrlParameter('cid')+"&offer_id="+getUrlParameter('offer_id');
