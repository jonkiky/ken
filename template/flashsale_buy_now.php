...
<section class="container main-content buy-now-content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
                ...
                <h1><strong>Here is Your  {{ parseInt((1-sale_price/normal_price)*100)}}% off  Amazon.com Coupon Code</strong></h1>
             ...
             <!--    <p>To celebrate the launch of our new product, we've decided to practically give away our new {{name}} for only {{market_place }}{{sale_price}}, Free Shipping! for just {{market_place }}{{sale_price}}.</p> -->
                ...
                <h1 class="blue"><strong>How To Get This for  {{parseInt((1-sale_price/normal_price)*100)}}% Off On Amazon.com</strong></h1>
                ...
                <p>Remember, to do it right now because there are only {{numbers_coupons_avi}} left available at this discount of  {{ parseInt((1-sale_price/normal_price)*100)}}% Off . We have a limited supply and this incredible {{market_place }}{{sale_price}}  deal will end within a few hours today when they are sold.</p>
